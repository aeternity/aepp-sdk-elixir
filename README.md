...
mix build_api v1.2.0-elixir v5.0.0-rc.2
```
Where:
 ...
 - `v5.0.0-rc.2` - Aeternity node API [specification file](https://github.com/aeternity/aeternity/blob/v5.0.0-rc.2/apps/aehttp/priv/swagger.yaml).
