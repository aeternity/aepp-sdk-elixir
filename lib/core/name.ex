defmodule AeppSDK.Core.AENS do
  @moduledoc """
  ...
  ## Example
      iex> name = "a123.test"
      iex> AeppSDK.Core.AENS.preclaim(client, name)
      {:ok,
        %{
          block_hash: "mh_Dumv7aK8Nb8Cedm7z1tMvWDMhVZqoc1VHbEgb1V484tZssK6d",
          block_height: 86,
          client: %AeppSDK.Core.Client{
  ...
  ## Example
      iex> client |> AeppSDK.Core.AENS.preclaim("a123.test") |> AeppSDK.Core.AENS.claim()
      {:ok,
       %{
  ...
  ## Example
      ...
      iex> AeppSDK.Core.AENS.claim(client, name, name_salt)
      {:ok,
        %{
  ...
  ## Example
      ...
      iex> client |> AeppSDK.Core.AENS.preclaim(name) |> AeppSDK.Core.AENS.claim() |> AeppSDK.Core.AENS.update(pointers, name_ttl,  client_ttl)
      {:ok,
        %{
  ...
  """
  @spec update(
          {:ok, %{client: AeppSDK.Core.Client.t(), name: binary()}} | {:error, String.t()},
          list(),
          non_neg_integer(),
          non_neg_integer(),
          aens_options()
  ...
  ## Example
      ...
      iex> pointers = []
      iex> client_ttl = 50_000
      iex> AeppSDK.Core.AENS.update_name(client, name, name_ttl, pointers, client_ttl)
      {:ok,
        %{
          block_hash: "mh_bDauziEPcfsqZQMyBqLX2grxiD9p9iorsF2utsaCZQtwrEX2T",
          block_height: 41,
  ...
  ## Example
      ...
      iex> client |> AeppSDK.Core.AENS.preclaim(name) |> AeppSDK.Core.AENS.claim() |>  AeppSDK.Core.AENS.transfer(recipient_key)
      {:ok,
        %{
  ...
  ## Example
      iex> name = "a123.test"
      iex> recipient_key = "ak_nv5B93FPzRHrGNmMdTDfGdd5xGZvep3MVSpJqzcQmMp59bBCv"
      iex> AeppSDK.Core.AENS.transfer_name(client, name, recipient_key)
      {:ok,
        %{
          block_hash: "mh_NSyuLSvbB1v4R8nz8ZCLLHQXCHtsBntNyYbWdeKTadFm8Y5nB",
          block_height: 35,
  ...
  ## Example
      iex> name = "a123.test"
      iex> client |> AeppSDK.Core.AENS.preclaim(name) |> AeppSDK.Core.AENS.claim() |> AeppSDK.Core.AENS.revoke()
      {:ok,
        %{
  ...
  ## Example
      iex> name = "a123.test"
      iex> AeppSDK.Core.AENS.revoke_name(client, name)
      {:ok,
        %{
          block_hash: "mh_21fw4AryJSGKkdaQsigFQwkydfFVbN2mY7G5pRvwq7rp4zmfYC",
          block_height: 24,
