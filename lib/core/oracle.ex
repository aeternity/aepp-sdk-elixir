defmodule AeppSDK.Core.Oracle do
  @moduledoc """
  ...
  ## Example
      ...
      iex> query_fee = 100
      iex> AeppSDK.Core.Oracle.register(client, query_format, response_format, oracle_ttl, query_fee)
      {:ok,
        %{
  ...
  ## Example
      ...
      iex> response_ttl = 10
      iex> AeppSDK.Core.Oracle.query(client, oracle_id, query, query_ttl, response_ttl)
      {:ok,
       %{
  ...
  ## Example
      ...
      iex> query_ttl = %{type: :relative, value: 10}
      iex> response_ttl = 10
      iex> AeppSDK.Core.Oracle.respond(client, oracle_id, response, response_ttl)
      {:ok,
       %{
  ...
  ## Example
      iex> oracle_id = "ok_4K1dYTkXcLwoUEat9fMgVp3RrG3HTD51v4VzszYDgt2MqxzKM"
      iex> ttl = 10
      iex> AeppSDK.Core.Oracle.extend(client, oracle_id, ttl)
      {:ok,
       %{
  ...
  ## Example
      ...
      iex> AeppSDK.Core.Oracle.get_oracle(client, oracle_id)
      {:ok,
       %{
         abi_version: 1,
  ...
  ## Example
      iex> oracle_id = "ok_6A2vcm1Sz6aqJezkLCssUXcyZTX7X8D5UwbuS2fRJr9KkYpRU"
      iex> AeppSDK.Core.Oracle.get_queries(client, oracle_id)
      {:ok,
       [
         %{
           fee: 30,
  ...
  ## Example
      ...
      iex> AeppSDK.Core.Oracle.get_query(client, oracle_id, query_id)
      {:ok,
       %{
         fee: 30,
         id: "oq_253A8BSZqUofetC5U9DqdJfYAcF5SHi6DPr5gPPSrayP8cwSUP",
