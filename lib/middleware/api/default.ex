defmodule Aeternal.Api.Default do
  ...
  @doc """
  Get info in a given auction

  ## Parameters

  - connection (Aeternal.Connection): Connection to server
  - name (String.t): The name to get info on
  - opts (KeywordList): [optional] Optional parameters
  ## Returns
  ...
  {:error, info} on failure
  """
  @spec get_auction_info(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  def get_auction_info(connection, name, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/names/auctions/#{name}/info")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, false}
  ...
  {:error, info} on failure
  """
  @spec get_contract_creation_tx(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  def get_contract_creation_tx(connection, address, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/contracts/transactions/creation/address/#{address}")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, false}
  ...
  {:error, info} on failure
  """
  @spec get_generations_by_range_0(Tesla.Env.client(), integer(), integer(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  def get_generations_by_range_0(connection, from, to, opts \\ []) do
    optional_params = %{
      :limit => :query,
      :page => :query
    }
  ...
  @doc """
  Given a name hash, return the name and associated info

  ## Parameters

  - connection (Aeternal.Connection): Connection to server
  - hash (String.t): The hash of the name
  - opts (KeywordList): [optional] Optional parameters
  ## Returns
  ...
  {:error, info} on failure
  """
  @spec get_name_for_hash(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  def get_name_for_hash(connection, hash, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/names/hash/#{hash}")
    |> Enum.into([])
