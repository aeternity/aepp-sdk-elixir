defmodule AeppMiddleware.Api.Default do
  @moduledoc """
  API calls for all endpoints tagged `Default`.
  """

  alias AeppMiddleware.Connection
  import AeppMiddleware.RequestBuilder
  ...
  - connection (AeppMiddleware.Connection): Connection to server
